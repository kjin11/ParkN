...
import com.example.kejin.iot_demo.widget.OnWheelChangedListener;
import com.example.kejin.iot_demo.widget.OnWheelScrollListener;
import com.example.kejin.iot_demo.widget.WheelView;
import com.example.kejin.iot_demo.widget.adapters.AbstractWheelTextAdapter;
...
//                mDateCalendarTextView.setText(" " + arry_date.get(wheel.getCurrentItem()));
    ...
    private String strTimeToDateFormat(String yearStr, String dateStr, String hourStr, String minuteStr) {
        ...
        return yearStr.replace("year", "-") + dateStr.replace(" / ", "-").replace("day", " ")
                + hourStr + ":" + minuteStr;
    }
